package com.gloryfootwarefsm.features.login.presentation
...
import com.gloryfootwarefsm.CustomStatic
import com.gloryfootwarefsm.R
import com.gloryfootwarefsm.app.*
import com.gloryfootwarefsm.app.AlarmReceiver.Companion.setAlarm
import com.gloryfootwarefsm.app.domain.*
import com.gloryfootwarefsm.app.utils.*
import com.gloryfootwarefsm.app.utils.AppUtils.Companion.getCurrentTimeInMintes
import com.gloryfootwarefsm.base.BaseResponse
import com.gloryfootwarefsm.base.presentation.BaseActivity
import com.gloryfootwarefsm.features.activities.api.ActivityRepoProvider
import com.gloryfootwarefsm.features.activities.model.*
import com.gloryfootwarefsm.features.addAttendence.FingerprintDialog
import com.gloryfootwarefsm.features.addAttendence.SelfieDialog
import com.gloryfootwarefsm.features.addshop.api.AddShopRepositoryProvider
import com.gloryfootwarefsm.features.addshop.api.areaList.AreaListRepoProvider
import com.gloryfootwarefsm.features.addshop.api.assignToPPList.AssignToPPListRepoProvider
import com.gloryfootwarefsm.features.addshop.api.assignedToDDList.AssignToDDListRepoProvider
import com.gloryfootwarefsm.features.addshop.api.typeList.TypeListRepoProvider
import com.gloryfootwarefsm.features.addshop.model.*
import com.gloryfootwarefsm.features.addshop.model.TypeListResponseModel
import com.gloryfootwarefsm.features.addshop.model.assigntoddlist.AssignToDDListResponseModel
import com.gloryfootwarefsm.features.addshop.model.assigntopplist.AssignToPPListResponseModel
...
import com.gloryfootwarefsm.features.beatCustom.api.GetBeatRegProvider
import com.gloryfootwarefsm.features.billing.api.billinglistapi.BillingListRepoProvider
import com.gloryfootwarefsm.features.billing.model.BillingListResponseModel
...
import com.gloryfootwarefsm.features.dashboard.presentation.api.dayStartEnd.DayStartEndRepoProvider
import com.gloryfootwarefsm.features.dashboard.presentation.api.gteroutelistapi.GetRouteListRepoProvider
import com.gloryfootwarefsm.features.dashboard.presentation.model.SelectedRouteListResponseModel
import com.gloryfootwarefsm.features.dashboard.presentation.model.StatusDayStartEnd
import com.gloryfootwarefsm.features.document.api.DocumentRepoProvider
import com.gloryfootwarefsm.features.document.model.DocumentListResponseModel
import com.gloryfootwarefsm.features.document.model.DocumentTypeResponseModel
import com.gloryfootwarefsm.features.forgotpassword.presentation.ForgotPasswordDialog
import com.gloryfootwarefsm.features.location.LocationWizard
import com.gloryfootwarefsm.features.location.SingleShotLocationProvider
import com.gloryfootwarefsm.features.location.UserLocationDataEntity
...
import com.gloryfootwarefsm.features.login.UserLoginDataEntity
import com.gloryfootwarefsm.features.login.api.LoginRepositoryProvider
import com.gloryfootwarefsm.features.login.api.alarmconfigapi.AlarmConfigRepoProvider
import com.gloryfootwarefsm.features.login.api.global_config.ConfigFetchRepoProvider
import com.gloryfootwarefsm.features.login.api.productlistapi.ProductListRepoProvider
import com.gloryfootwarefsm.features.login.api.user_config.UserConfigRepoProvider
import com.gloryfootwarefsm.features.login.model.*
import com.gloryfootwarefsm.features.login.model.alarmconfigmodel.AlarmConfigResponseModel
import com.gloryfootwarefsm.features.login.model.globalconfig.ConfigFetchResponseModel
import com.gloryfootwarefsm.features.login.model.mettingListModel.MeetingListResponseModel
import com.gloryfootwarefsm.features.login.model.productlistmodel.ModelListResponse
import com.gloryfootwarefsm.features.login.model.productlistmodel.NewOdrScrOrderListModel
...
import com.gloryfootwarefsm.features.meetinglist.api.MeetingRepoProvider
import com.gloryfootwarefsm.features.member.api.TeamRepoProvider
import com.gloryfootwarefsm.features.member.model.TeamAreaListResponseModel
import com.gloryfootwarefsm.features.member.model.UserPjpResponseModel
import com.gloryfootwarefsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.gloryfootwarefsm.features.nearbyshops.model.*
import com.gloryfootwarefsm.features.newcollection.model.NewCollectionListResponseModel
import com.gloryfootwarefsm.features.newcollection.model.PaymentModeResponseModel
import com.gloryfootwarefsm.features.newcollection.newcollectionlistapi.NewCollectionListRepoProvider
import com.gloryfootwarefsm.features.orderList.api.neworderlistapi.NewOrderListRepoProvider
import com.gloryfootwarefsm.features.orderList.model.NewOrderListResponseModel
import com.gloryfootwarefsm.features.orderList.model.ReturnListResponseModel
import com.gloryfootwarefsm.features.quotation.api.QuotationRepoProvider
import com.gloryfootwarefsm.features.quotation.model.BSListResponseModel
import com.gloryfootwarefsm.features.quotation.model.QuotationListResponseModel
import com.gloryfootwarefsm.features.stock.api.StockRepositoryProvider
import com.gloryfootwarefsm.features.stock.model.NewStockListResponseModel
import com.gloryfootwarefsm.features.stockAddCurrentStock.api.ShopAddStockProvider
import com.gloryfootwarefsm.features.stockAddCurrentStock.model.CurrentStockGetData
import com.gloryfootwarefsm.features.stockCompetetorStock.api.AddCompStockProvider
import com.gloryfootwarefsm.features.stockCompetetorStock.model.CompetetorStockGetData
import com.gloryfootwarefsm.features.task.api.TaskRepoProvider
import com.gloryfootwarefsm.features.task.model.TaskListResponseModel
import com.gloryfootwarefsm.features.timesheet.api.TimeSheetRepoProvider
import com.gloryfootwarefsm.features.timesheet.model.TimeSheetConfigResponseModel
import com.gloryfootwarefsm.features.timesheet.model.TimeSheetDropDownResponseModel
import com.gloryfootwarefsm.features.viewAllOrder.api.OrderDetailsListRepoProvider
import com.gloryfootwarefsm.features.viewAllOrder.model.NewOrderDataModel
import com.gloryfootwarefsm.features.viewPPDDStock.api.stocklist.StockListRepoProvider
import com.gloryfootwarefsm.features.viewPPDDStock.model.stocklist.StockListDataModel
import com.gloryfootwarefsm.features.viewPPDDStock.model.stocklist.StockListResponseModel
    ...
    private fun getMeetingList() {
        ...
        BaseActivity.compositeDisposable.add(
                repository.meetingList()
                        ...
                        .subscribeOn(Schedulers.io())
                        .subscribe({ result ->
                            val response = result as com.gloryfootwarefsm.features.meetinglist.model.MeetingListResponseModel
                            if (response.status == NetworkConstant.SUCCESS) {
    ...
    private fun getTypeApi() {
        ...
        BaseActivity.compositeDisposable.add(
                repository.typeList()
                        ...
                        .subscribeOn(Schedulers.io())
                        .subscribe({ result ->
                            val response = result as com.gloryfootwarefsm.features.activities.model.TypeListResponseModel
                            if (response.status == NetworkConstant.SUCCESS) {
                                val list = response.type_list
    ...
    fun openShareDB(dbpath:String) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R){
                currentDBPath="/data/user/0/com.gloryfootwarefsm/databases/fts_db"
            }
