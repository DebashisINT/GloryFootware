package com.gloryfootwarefsm.features.activities.presentation
...
import com.gloryfootwarefsm.app.domain.AddDoctorEntity
import com.gloryfootwarefsm.app.domain.AddDoctorProductListEntity
...
import com.gloryfootwarefsm.features.activities.model.AddChemistProductModel
import com.gloryfootwarefsm.features.activities.model.AddDoctorVisitInputModel
import com.gloryfootwarefsm.features.activities.model.ProductListModel
...
class EditDoctorActivityFragment : BaseFragment(), View.OnClickListener {
    ...
    private fun callUploadDocVisitApi(docVisit: AddDoctorVisitInputModel) {
        ...
        XLog.d("=====EDIT DOCTOR VISIT INPUT PARAMS (EDIT DOCTOR)======")
        ...
        BaseActivity.compositeDisposable.add(
                repository.uploadDoctorVisit(docVisit)
                        ...
                        .subscribe({ result ->
                            ...
                            XLog.d("EDIT DOCTOR VISIT DETAILS : " + "RESPONSE : " + response.status + "\n" + "Time : " + AppUtils.getCurrentDateTime() + ", USER :" + Pref.user_name + ", MESSAGE : " + response.message)
                            ...
                            XLog.d("EDIT DOCTOR VISIT DETAILS : " + "ERROR : " + "\n" + "Time : " + AppUtils.getCurrentDateTime() + ", USER :" + Pref.user_name + ", MESSAGE : " + error.localizedMessage)
                            progress_wheel.stopSpinning()
