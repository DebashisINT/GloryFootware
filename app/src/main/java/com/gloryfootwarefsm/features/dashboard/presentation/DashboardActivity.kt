package com.gloryfootwarefsm.features.dashboard.presentation
...
import com.gloryfootwarefsm.*
import com.gloryfootwarefsm.ContactUtils.retrieveAllContacts
import com.gloryfootwarefsm.R
import com.gloryfootwarefsm.app.*
import com.gloryfootwarefsm.app.NewFileUtils.browseDocuments
import com.gloryfootwarefsm.app.NewFileUtils.getExtension
import com.gloryfootwarefsm.app.domain.*
import com.gloryfootwarefsm.app.types.DashboardType
import com.gloryfootwarefsm.app.types.FragType
import com.gloryfootwarefsm.app.types.TopBarConfig
import com.gloryfootwarefsm.app.uiaction.DisplayAlert
import com.gloryfootwarefsm.app.utils.*
import com.gloryfootwarefsm.app.utils.AppUtils.Companion.isProfile
import com.gloryfootwarefsm.base.BaseResponse
import com.gloryfootwarefsm.base.presentation.BaseActivity
import com.gloryfootwarefsm.base.presentation.BaseFragment
import com.gloryfootwarefsm.features.NewQuotation.*
import com.gloryfootwarefsm.features.NewQuotation.api.GetQuotRegProvider
import com.gloryfootwarefsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.gloryfootwarefsm.features.NewQuotation.model.shop_wise_quotation_list
import com.gloryfootwarefsm.features.SearchLocation.SearchLocationFragment
import com.gloryfootwarefsm.features.SearchLocation.locationInfoModel
import com.gloryfootwarefsm.features.TA.ViewAllTAListFragment
import com.gloryfootwarefsm.features.achievement.AchievementFragment
import com.gloryfootwarefsm.features.activities.presentation.*
import com.gloryfootwarefsm.features.addAttendence.*
import com.gloryfootwarefsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.gloryfootwarefsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.gloryfootwarefsm.features.addAttendence.model.GetReportToFCMResponse
import com.gloryfootwarefsm.features.addAttendence.model.GetReportToResponse
import com.gloryfootwarefsm.features.addAttendence.model.Leave_list_Response
import com.gloryfootwarefsm.features.addorder.presentation.AddOrderFragment
...
import com.gloryfootwarefsm.features.addshop.presentation.AddShopFragment
import com.gloryfootwarefsm.features.addshop.presentation.OTPVerificationDialog
import com.gloryfootwarefsm.features.addshop.presentation.ScanImageFragment
import com.gloryfootwarefsm.features.addshop.presentation.ShowCardDetailsDialog
import com.gloryfootwarefsm.features.alarm.model.AlarmData
import com.gloryfootwarefsm.features.alarm.presetation.AttendanceReportFragment
import com.gloryfootwarefsm.features.alarm.presetation.PerformanceReportFragment
import com.gloryfootwarefsm.features.alarm.presetation.VisitReportDetailsFragment
import com.gloryfootwarefsm.features.alarm.presetation.VisitReportFragment
import com.gloryfootwarefsm.features.attendance.AttendanceFragment
import com.gloryfootwarefsm.features.attendance.api.AttendanceRepositoryProvider
import com.gloryfootwarefsm.features.attendance.model.AttendanceRequest
import com.gloryfootwarefsm.features.attendance.model.AttendanceResponse
import com.gloryfootwarefsm.features.averageshop.presentation.AverageShopFragment
import com.gloryfootwarefsm.features.avgorder.presentation.AverageOrderFragment
import com.gloryfootwarefsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.gloryfootwarefsm.features.beatCustom.TeamBeatListFragment
import com.gloryfootwarefsm.features.billing.presentation.AddBillingFragment
import com.gloryfootwarefsm.features.billing.presentation.BillingDetailsFragment
import com.gloryfootwarefsm.features.billing.presentation.BillingListFragment
import com.gloryfootwarefsm.features.changepassword.presentation.ChangePasswordDialog
import com.gloryfootwarefsm.features.chat.model.ChatListDataModel
import com.gloryfootwarefsm.features.chat.model.ChatUserDataModel
import com.gloryfootwarefsm.features.chat.model.GroupUserDataModel
import com.gloryfootwarefsm.features.chat.presentation.*
import com.gloryfootwarefsm.features.chatbot.presentation.ChatBotFragment
import com.gloryfootwarefsm.features.chatbot.presentation.ChatBotShopListFragment
import com.gloryfootwarefsm.features.chatbot.presentation.ReportsFragment
import com.gloryfootwarefsm.features.chatbot.presentation.SelectLanguageDialog
import com.gloryfootwarefsm.features.commondialog.presentation.CommonDialog
import com.gloryfootwarefsm.features.commondialog.presentation.CommonDialogClickListener
import com.gloryfootwarefsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.gloryfootwarefsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.gloryfootwarefsm.features.commondialogsinglebtn.OnDialogClickListener
import com.gloryfootwarefsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.gloryfootwarefsm.features.dailyPlan.prsentation.AllShopListFragment
import com.gloryfootwarefsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.gloryfootwarefsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.gloryfootwarefsm.features.damageProduct.ShopDamageProductListFrag
import com.gloryfootwarefsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.gloryfootwarefsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.gloryfootwarefsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.gloryfootwarefsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.gloryfootwarefsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.gloryfootwarefsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.gloryfootwarefsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.gloryfootwarefsm.features.dashboard.presentation.model.ContentListResponseModel
import com.gloryfootwarefsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.gloryfootwarefsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.gloryfootwarefsm.features.device_info.presentation.DeviceInfoListFragment
import com.gloryfootwarefsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.gloryfootwarefsm.features.document.DocumentRepoFeatureNewFragment
import com.gloryfootwarefsm.features.document.presentation.DocumentListFragment
import com.gloryfootwarefsm.features.document.presentation.DocumentTypeListFragment
import com.gloryfootwarefsm.features.document.presentation.OpenFileWebViewFragment
import com.gloryfootwarefsm.features.dymanicSection.presentation.AddDynamicFragment
import com.gloryfootwarefsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.gloryfootwarefsm.features.dymanicSection.presentation.DynamicListFragment
import com.gloryfootwarefsm.features.dymanicSection.presentation.EditDynamicFragment
import com.gloryfootwarefsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.gloryfootwarefsm.features.home.presentation.HomeFragment
import com.gloryfootwarefsm.features.homelocation.presentation.HomeLocationFragment
import com.gloryfootwarefsm.features.homelocation.presentation.HomeLocationMapFragment
import com.gloryfootwarefsm.features.know_your_state.KnowYourStateFragment
import com.gloryfootwarefsm.features.lead.LeadFrag
import com.gloryfootwarefsm.features.lead.ViewLeadFrag
import com.gloryfootwarefsm.features.leaveapplynew.LeaveHome
import com.gloryfootwarefsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.gloryfootwarefsm.features.localshops.LocalShopListFragment
import com.gloryfootwarefsm.features.localshops.LocalShopListMapFragment
import com.gloryfootwarefsm.features.localshops.NearByShopsMapFragment
import com.gloryfootwarefsm.features.location.*
import com.gloryfootwarefsm.features.location.api.LocationRepoProvider
import com.gloryfootwarefsm.features.location.model.*
import com.gloryfootwarefsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.gloryfootwarefsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.gloryfootwarefsm.features.login.ShopFeedbackEntity
import com.gloryfootwarefsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.gloryfootwarefsm.features.login.presentation.LoginActivity
import com.gloryfootwarefsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.gloryfootwarefsm.features.logoutsync.presentation.LogoutSyncFragment
import com.gloryfootwarefsm.features.marketing.presentation.MarketingPagerFragment
import com.gloryfootwarefsm.features.meetinglist.prsentation.MeetingListFragment
import com.gloryfootwarefsm.features.member.MapViewForTeamFrag
import com.gloryfootwarefsm.features.member.model.TeamLocDataModel
import com.gloryfootwarefsm.features.member.model.TeamShopListDataModel
import com.gloryfootwarefsm.features.member.presentation.*
import com.gloryfootwarefsm.features.menuBeat.MenuBeatFrag
import com.gloryfootwarefsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.gloryfootwarefsm.features.micro_learning.presentation.MicroLearningListFragment
import com.gloryfootwarefsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.gloryfootwarefsm.features.myallowancerequest.MyallowanceRequestFragment
import com.gloryfootwarefsm.features.myjobs.model.CustomerDataModel
import com.gloryfootwarefsm.features.myjobs.presentation.*
import com.gloryfootwarefsm.features.myorder.presentation.MyOrderListFragment
import com.gloryfootwarefsm.features.myprofile.presentation.MyProfileFragment
import com.gloryfootwarefsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.gloryfootwarefsm.features.nearbyshops.model.ShopData
import com.gloryfootwarefsm.features.nearbyshops.model.ShopListResponse
import com.gloryfootwarefsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.gloryfootwarefsm.features.nearbyshops.presentation.BeatListFragment
import com.gloryfootwarefsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.gloryfootwarefsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.gloryfootwarefsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.gloryfootwarefsm.features.newcollection.CollectionDetailsStatusFragment
import com.gloryfootwarefsm.features.newcollection.CollectionShopListFragment
import com.gloryfootwarefsm.features.newcollection.NewCollectionListFragment
import com.gloryfootwarefsm.features.newcollectionreport.*
import com.gloryfootwarefsm.features.notification.NotificationFragment
import com.gloryfootwarefsm.features.orderList.NewDateWiseOrderListFragment
import com.gloryfootwarefsm.features.orderList.NewOrderListFragment
import com.gloryfootwarefsm.features.orderList.OrderListFragment
import com.gloryfootwarefsm.features.orderdetail.presentation.OrderDetailFragment
import com.gloryfootwarefsm.features.orderhistory.ActivityMapFragment
import com.gloryfootwarefsm.features.orderhistory.OrderhistoryFragment
import com.gloryfootwarefsm.features.orderhistory.TimeLineFragment
import com.gloryfootwarefsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.gloryfootwarefsm.features.orderhistory.model.LocationData
import com.gloryfootwarefsm.features.pendinglocationinout.PendingOutLocationFrag
import com.gloryfootwarefsm.features.performance.GpsStatusFragment
import com.gloryfootwarefsm.features.performance.PerformanceFragment
import com.gloryfootwarefsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.gloryfootwarefsm.features.performance.model.Gps_status_list
import com.gloryfootwarefsm.features.performance.model.UpdateGpsInputListParamsModel
import com.gloryfootwarefsm.features.performance.model.UpdateGpsInputParamsModel
import com.gloryfootwarefsm.features.permissionList.ViewPermissionFragment
import com.gloryfootwarefsm.features.photoReg.*
import com.gloryfootwarefsm.features.quotation.presentation.*
import com.gloryfootwarefsm.features.reimbursement.presentation.*
import com.gloryfootwarefsm.features.report.presentation.*
import com.gloryfootwarefsm.features.returnsOrder.*
import com.gloryfootwarefsm.features.settings.presentation.SettingsFragment
import com.gloryfootwarefsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.gloryfootwarefsm.features.shopdetail.presentation.*
import com.gloryfootwarefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.gloryfootwarefsm.features.stock.StockDetailsFragment
import com.gloryfootwarefsm.features.stock.StockListFragment
import com.gloryfootwarefsm.features.stockAddCurrentStock.AddShopStockFragment
import com.gloryfootwarefsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.gloryfootwarefsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.gloryfootwarefsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.gloryfootwarefsm.features.stockCompetetorStock.CompetetorStockFragment
import com.gloryfootwarefsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.gloryfootwarefsm.features.survey.SurveyFrag
import com.gloryfootwarefsm.features.survey.SurveyViewDtlsFrag
import com.gloryfootwarefsm.features.survey.SurveyViewFrag
import com.gloryfootwarefsm.features.task.presentation.AddTaskFragment
import com.gloryfootwarefsm.features.task.presentation.CalenderTaskFragment
import com.gloryfootwarefsm.features.task.presentation.EditTaskFragment
import com.gloryfootwarefsm.features.task.presentation.TaskListFragment
import com.gloryfootwarefsm.features.timesheet.presentation.AddTimeSheetFragment
import com.gloryfootwarefsm.features.timesheet.presentation.EditTimeSheetFragment
import com.gloryfootwarefsm.features.timesheet.presentation.TimeSheetListFragment
import com.gloryfootwarefsm.features.viewAllOrder.CartFragment
import com.gloryfootwarefsm.features.viewAllOrder.OrderTypeListFragment
import com.gloryfootwarefsm.features.viewAllOrder.ViewAllOrderListFragment
import com.gloryfootwarefsm.features.viewAllOrder.ViewCartFragment
import com.gloryfootwarefsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.gloryfootwarefsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.gloryfootwarefsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.gloryfootwarefsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.gloryfootwarefsm.features.viewPPDDStock.ViewOutstandingFragment
import com.gloryfootwarefsm.features.viewPPDDStock.ViewPPDDListFragment
import com.gloryfootwarefsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.gloryfootwarefsm.features.viewPPDDStock.ViewStockFragment
import com.gloryfootwarefsm.features.weather.presentation.WeatherFragment
import com.gloryfootwarefsm.mappackage.MapActivity
import com.gloryfootwarefsm.mappackage.MapActivityWithoutPath
import com.gloryfootwarefsm.mappackage.SendBrod
import com.gloryfootwarefsm.widgets.AppCustomEditText
import com.gloryfootwarefsm.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xgloryfootwarefsmlogsample/log").path);
            //27-09-2021
            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgloryfootwarefsmlogsample/log").path);
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgloryfootwarefsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgloryfootwarefsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgloryfootwarefsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgloryfootwarefsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
...
//                            saveDataAsPdf(addQuotEditResult)
    ...
    private fun saveDataAsPdfN(addQuotEditResult: ViewDetailsQuotResponse,pdfTtemplateName : String) {
        var document: Document = Document(PageSize.A4, 36f, 36f, 65f, 130f)
