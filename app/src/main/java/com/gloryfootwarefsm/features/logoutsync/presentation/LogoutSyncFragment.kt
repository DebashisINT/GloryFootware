package com.gloryfootwarefsm.features.logoutsync.presentation
...
import com.gloryfootwarefsm.app.AppDatabase
import com.gloryfootwarefsm.app.NetworkConstant
...
import com.gloryfootwarefsm.app.utils.Toaster
import com.gloryfootwarefsm.base.BaseResponse
import com.gloryfootwarefsm.base.presentation.BaseActivity
import com.gloryfootwarefsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.gloryfootwarefsm.features.billing.api.AddBillingRepoProvider
import com.gloryfootwarefsm.features.billing.model.AddBillingInputParamsModel
...
import com.gloryfootwarefsm.features.dashboard.presentation.ReasonDialog
...
import com.gloryfootwarefsm.features.document.model.AddEditDocumentInputParams
import com.gloryfootwarefsm.features.document.model.DocumentAttachmentModel
...
import com.gloryfootwarefsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.gloryfootwarefsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.gloryfootwarefsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.gloryfootwarefsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.gloryfootwarefsm.features.orderhistory.model.*
...
import com.gloryfootwarefsm.features.quotation.model.AddQuotInputModel
import com.gloryfootwarefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.gloryfootwarefsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.gloryfootwarefsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.gloryfootwarefsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.gloryfootwarefsm.features.timesheet.model.AddTimeSheetInputModel
import com.gloryfootwarefsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.gloryfootwarefsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.gloryfootwarefsm.features.viewAllOrder.model.AddOrderInputProductList
import com.gloryfootwarefsm.mappackage.SendBrod
import com.gloryfootwarefsm.widgets.AppCustomTextView
import com.gloryfootwarefsm.MonitorService
...
import com.gloryfootwarefsm.features.addshop.presentation.ShopExtraContactReq
...
import com.gloryfootwarefsm.features.login.model.GetConcurrentUserResponse
...
import com.gloryfootwarefsm.features.returnsOrder.ReturnProductList
import com.gloryfootwarefsm.features.returnsOrder.ReturnRequest
import com.gloryfootwarefsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgloryfootwarefsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgloryfootwarefsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgloryfootwarefsmlogsample/log.zip").path);
